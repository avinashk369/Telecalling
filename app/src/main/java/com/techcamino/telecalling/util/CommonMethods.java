...
public class CommonMethods {
    ...
    public String getTIme()
    {
        ...
        String time=String.valueOf(hr)+"_"+String.valueOf(min)+"_"+String.valueOf(sec);
    ...
    public String getPath()
    {
        ...
        File file=new File(Environment.getExternalStorageDirectory()+"/health_telecalling/");
        File file1=new File(Environment.getExternalStorageDirectory()+"/health_telecalling/"+internalFile+"/");
        if(!file.exists())
        {
            file.mkdir();
        }
    ...
    public int mediaDuration(Context context, String mediaPath){
