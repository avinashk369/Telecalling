...
public class FollowupList extends AppCompatActivity implements FollowupAdapter.CustomDialogListener {

    private Context context = this;
    private APIInterFace apiService;
    private ProgressDialog dialog;
    private ArrayList<FollowupDetails> followupDetailsArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.followup_list);
        ...
        rv = (RecyclerView) findViewById(R.id.followup_list);
        progressBar = (ProgressBar) findViewById(R.id.main_progress);

        queryData = new HashMap<>();
        adapter = new FollowupAdapter(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                Intent i = new Intent(FollowupList.this, FilterActivity.class);
                i.putExtra(Constants.INQUIRY_DETAIL,false);
                startActivity(i);
                finish();
                return true;
            default:
    ...
    private Call<ArrayList<InquiryDetails>> callRecordLogApi() {
        return apiService.getFollowupList(queryData);
    }

    @Override
    public void onImageClicked(InquiryDetails inquiry) {
        Intent remark = new Intent(FollowupList.this, FollowRemark
                .class);
    ...
    public void onItemClicked(InquiryDetails inquiry) {
        Intent intent = new Intent(FollowupList.this, ViewInquiry
                .class);
